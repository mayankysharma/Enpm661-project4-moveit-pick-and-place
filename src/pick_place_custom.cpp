...
void pick(moveit::planning_interface::MoveGroupInterface& move_group)
{
  ...
  grasps[0].grasp_pose.pose.position.x = 0.39;
  grasps[0].grasp_pose.pose.position.y = 0;
  grasps[0].grasp_pose.pose.position.z = 0.57;
  ...
  move_group.setSupportSurfaceName("custom_table1");
...
void place(moveit::planning_interface::MoveGroupInterface& group)
{
  ...
  place_location[0].place_pose.pose.position.z = 0.098;
...
void addCollisionObjects(moveit::planning_interface::PlanningSceneInterface& planning_scene_interface)
{
  ...
  collision_objects[0].id = "custom_table1";
  // shapes::Mesh* m = shapes::createMeshFromResource("package://moveit_tutorials/pick_place/src/Table.stl",b);
  shapes::Mesh* m = shapes::createMeshFromResource("package://moveit_tutorials/doc/pick_place/src/Table.stl",b); 
  ROS_INFO("Custom table loaded");
  
  // scale the mesh
  double scale_factor = 0.5;
  for (std::size_t i = 0; i < m->vertex_count; ++i) {
    m->vertices[3*i] *= scale_factor;
    m->vertices[3*i+1] *= scale_factor;
    m->vertices[3*i+2] *= scale_factor;
  }
  ...
  collision_objects[0].mesh_poses[0].position.x = 0.4;
  collision_objects[0].mesh_poses[0].position.y = -0.5;
  collision_objects[0].mesh_poses[0].position.z = 0;
  collision_objects[0].mesh_poses[0].orientation.w= 0.5; 
  ...
  collision_objects[2].primitive_poses[0].position.z = 0.57;
